...
while cont < len(nuove_finestre):
    ...
    while k < len(sequenze_regioni[cont]):
        ...
        while i < len(nuove_finestre[cont]):
            if sequenze_regioni[cont][k] == nuove_finestre[cont][i:(i+distanza_frequente)]:
                #match_sequenze.append(nuove_finestre[cont][i:(i+distanza_frequente)])
                pos_iniziali.append(i)
                pos_finali.append(i+distanza_frequente)
            else:
                caratteri_diversi = 0
                app1 = sequenze_regioni[cont][k]
                app2 = nuove_finestre[cont][i:(i+distanza_frequente)]
                j = 0
